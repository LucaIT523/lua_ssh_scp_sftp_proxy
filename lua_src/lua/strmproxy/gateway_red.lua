...
switch[2222]=function()
    local Handlers =require "strmproxy.ftphandler"
	...
	require ("strmproxy.balancer.balancer"):new{
        ...
        -- {ip="10.0.20.213",port=21,id="srv21",gid="ftpServer"},
        {ip="10.0.20.213",port=21},
    }
...
switch[3336]=function()
    ...
    local Handlers =require "strmproxy.mysqlhandler"
    local OnConnect = Handlers.OnConnect
    local OnLogin = Handlers.OnLogin
    local OnLoginSuccess = Handlers.OnLoginSuccess
    local OnLoginFail = Handlers.OnLoginFail
	...
	--change to your own upstreams 
	require ("strmproxy.balancer.balancer"):new{
        -- {ip="127.0.0.1",port=3306,id="srv3306",gid="mysqlServer"},
        -- {ip="10.0.20.213",port=3306,id="dbtest",gid="mysql"},
        {ip="10.0.20.213",port=3306},
    }
