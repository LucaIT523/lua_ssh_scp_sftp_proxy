...
local pureluapack=require"strmproxy.utils.pureluapack"
local event=require "strmproxy.utils.event"
local ldapPackets=require "strmproxy.ldap.ldapPackets"
...
function _M:new()    
	...
	local ldapParser=require ("strmproxy.ldap.parser"):new()
